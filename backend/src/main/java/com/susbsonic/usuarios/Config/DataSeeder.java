...
public class DataSeeder {
    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            System.out.println("Comprobando datos iniciales...");

            // == 1. SEED USUARIOS (solo si no hay ninguno) ==
            if (userRepository.count() == 0) {
                ...
                System.out.println("Usuarios ya existentes, se omite seed.");
            }

            // == 2. SEED TICKETS (solo si no hay ninguno) ==
            if (ticketRepository.count() == 0) {
                ...
                System.out.println("Tickets iniciales creados.");
            } else {
                System.out.println("Tickets ya existentes, se omite seed.");
            }

            // == 3. SEED ARTISTAS (solo si no hay ninguno) ==
            if (artistRepository.count() == 0) {
                ...
                System.out.println("Artistas iniciales creados.");
            } else {
                System.out.println("Artistas ya existentes, se omite seed.");
            }

            // == 4. SEED ESPACIOS (solo si no hay ninguno) ==
            if (spaceRepository.count() == 0) {
                ...
                System.out.println("Espacios iniciales creados.");
            } else {
